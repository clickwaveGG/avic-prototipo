-- ══════════════════════════════════════════════════════════════
-- Migration: Quizzes (sabatinas)
-- Avicena — sistema de quiz com IA
-- ══════════════════════════════════════════════════════════════
...
-- Tentativas (cada vez que o usuário faz o quiz)
...
-- Quizzes: usuários veem/criam os próprios
DO $$ BEGIN
...
-- Questões: acessíveis se o quiz pertence ao usuário
DO $$ BEGIN
...
-- Tentativas: usuários veem/criam as próprias
DO $$ BEGIN
